...
- Worktree root: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/team/implement-the-approved-radar-p/worktrees/worker-1
- Team state root: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state
- Inbox path: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state/team/implement-the-approved-radar-p/workers/worker-1/inbox.md
- Mailbox path: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state/team/implement-the-approved-radar-p/mailbox/worker-1.json
...
- Worker status path: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state/team/implement-the-approved-radar-p/workers/worker-1/status.json
- Worker identity path: /root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state/team/implement-the-approved-radar-p/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/root/workspace/byungkwan-workspace/teaching/radar-ai-projects/.omx/state/team/implement-the-approved-radar-p/workers/worker-1/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"implement-the-approved-radar-p","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"implement-the-approved-radar-p","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"implement-the-approved-radar-p","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
